...
export default function PerformancePage() {
    ...
    const [postsData, setPostsData] = useState < PerformanceData[] > ([])
    const [usersData, setUsersData] = useState < PerformanceData[] > ([])
    ...
    const runPerformanceTest = async () => {
        ...
        const postsResults: PerformanceData[] = []
        for (let i = 1; i <= 5; i++) {
            // With cache
        ...
        const usersResults: PerformanceData[] = []
        for (let i = 1; i <= 5; i++) {
            // With cache
